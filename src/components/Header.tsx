  ...
  return (
    <header className={styles.header}>
      <div className={styles.left}>
        ...
        <Link href="/" className={styles.logo} style={{ gap: '8px' }}>
          <svg viewBox="0 0 24 24" width="36" height="36" className={styles.logoIcon}>
            <defs>
            ...
            <path fill="#0B0D14" d="M10 15.5v-7l6 3.5-6 3.5z"/>
          </svg>
          <span className={styles.logoText} style={{ display: 'flex', alignItems: 'center', fontSize: '26px', fontWeight: '800', letterSpacing: '-0.5px' }}>
            <span style={{ color: '#E50914', fontSize: '32px' }}>V</span>ix
            <svg viewBox="0 0 24 24" width="22" height="22" style={{ margin: '0 1px' }}>
              <circle cx="12" cy="12" r="10" fill="#E50914" />
              <path fill="#0B0D14" d="M10 16l5-4-5-4v8z" />
            </svg>
            ra
          </span>
        </Link>
      ...
      <div className={styles.center}>
        <form onSubmit={handleSearchSubmit} className={styles.searchBox}>
          ...
          <input 
            type="text" 
            placeholder="Search videos, channels, shows..." 
